...
function includes(current_users, new_user) {
...
function city_country2(name_of_city, country) {
...
function make_great(magicians) {
    const great_magicians = magicians.map(magicians => `the 
    great $(magician)`);
    return great_magicians;
}
const great_magicians_name = make_great(magicians_name);
